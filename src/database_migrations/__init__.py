...
_PROFILE_REQUIRED_COLUMNS = {
    "webui": {
        ...
        "source_deletion_operations": ("operation_id", "owner_id", "task_id", "idempotency_key", "request_hash", "plan_json", "state", "error_code", "created_at", "updated_at"),
        "source_deletions": ("owner_id", "source_key", "operation_id", "sha256", "snapshot_id", "state", "deleted_at"),
        ...
        "source_acquisition_attempts": ('attempt_id', 'owner_id', 'idempotency_key', 'request_hash', 'normalized_url', 'allowed_scope_json', 'purpose', 'status', 'started_at', 'finished_at', 'snapshot_id', 'error_code', 'cancel_requested_at', 'request_context', 'search_report_json', 'current_auth_request_id', 'connector_progress_json'),
        "source_snapshots": (
        ...
        "authenticated_source_connections": ('owner', 'website', 'account', 'active_version', 'ciphertext', 'usable'),
        "source_reauthentication_requests": ('request_id', 'idempotency_key', 'request_hash', 'owner', 'website', 'account', 'expected_version', 'binding_json', 'driver_version', 'authorization_digest', 'state', 'expires'),
        "authenticated_source_commands": ('owner', 'request_id', 'action', 'idempotency_key', 'fingerprint', 'state', 'receipt_json'),
