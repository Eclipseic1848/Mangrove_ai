...
export type ConnectorRequest = {
    ...
    purpose: string;
    expected_connection_version: string;
    resume_checkpoint: boolean;
};
export type ConnectorAttempt = Omit<SourceAcquisitionAttempt, "allowed_scope" | "snapshot"> & {
    allowed_scope: ConnectorScope;
    snapshot: SourceSnapshot<ConnectorScope> | null;
};
