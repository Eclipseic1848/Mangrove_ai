...
#134 已由 PR #171 合并关闭；本分支实现同一任务的文件与多个网页组，范围与门禁见
[#135 规格](docs/plans/2026-09-09-mixed-sources-spec.md)。先核关联 PR 的最终提交、CI、原件交付与两轴审查；工程替身不能证明真实模型关联或冲突澄清。若已合并关闭，按依赖继续 #136，不重做 #135。
