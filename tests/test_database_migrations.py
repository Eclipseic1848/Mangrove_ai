...
def _remove_platform_session_schema(connection: sqlite3.Connection) -> None:
    ...
    for table in ("workspace_feedback_content_access", "workspace_feedback_receipts", "workspace_feedback", "feedback_content_access", "account_execution_holds", "account_execution_bindings", "platform_spent_refresh", "platform_login_sessions", "platform_rate_events", "platform_rate_blocks", "platform_security_audit"):
